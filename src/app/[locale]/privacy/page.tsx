        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
            ...
            <div className="prose prose-lg max-w-none text-gray-400">
                ...
                <section className="mb-8 text-gray-800">
                    <h2 className="text-2xl font-semibold mb-4 text-gray-400"><TransletText>3. Vos Droits</TransletText></h2>
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg border border-gray-200 text-gray-800">
