      ...
      <header className="bg-white/80 backdrop-blur sticky top-0 z-10 border-b border-sand-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-display text-2xl text-gray-800">Établissements</h1>
          </div>
          <Link
    ...
    <div className="group relative bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow overflow-hidden">
      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex items-center gap-2">
          <Link
            href={`/${locale}/admin/etablissements/${id}/edit`}
          ...
          <button
            ...
            className="ml-auto inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full
                       bg-red-600 text-white text-sm hover:bg-red-700 transition"
          >
